...
public class PremierLeagueDAO {
	...
	public List<Adiacenza> getArchi(Match m, Map<Integer, Player> idMap) {
		String sql = "SELECT a1.PlayerID AS p1, a2.PlayerID AS p2, "
				...
				+ "WHERE a1.MatchID=? AND a2.MatchID=a1.MatchID "
	...
	public int getTeamGiocatoreMigliore(GiocatoreMigliore best) {
		String sql = "SELECT DISTINCT TeamID FROM actions WHERE PlayerID=?";
		int result;
		Connection conn = DBConnect.getConnection();
